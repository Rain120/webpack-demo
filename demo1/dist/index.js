    ...
    t.exports = function (t) {
      ...
      e.i = function (t, n) {
        ...
        for (o = 0; o < t.length; o++) {
          var s = t[o];
          "number" == typeof s[0] && r[s[0]] || (n && !s[2]
            ? s[2] = n
            : n && (s[2] = "(" + s[2] + ") and (" + n + ")"), e.push(s))
        }
      },
      e
    }
    ...
    function i(t, e) {
      ...
      if ("top" === t.insertAt) 
        ...
        if ("object" != typeof t.insertAt || !t.insertAt.before) 
          throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') f" +
              "ound.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contri" +
              "b/style-loader#insertat)\n");
    ...
    function f(t, e) {
      ...
      if (e.singleton) {
        ...
        t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa
          ? (n = u(e), r = d.bind(null, n, e), o = function () {
            s(n),
